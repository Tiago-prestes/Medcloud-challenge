export class User {
    constructor(
        ...
        if (typeof address !== "string") throw new Error("Type of 'address' must be a 'string'")
        if (typeof birthdate !== "string") throw new Error("Type of 'birthdate' must be a 'string'")
    }
}